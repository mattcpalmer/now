...
?>
                <div style="margin-left: 30px;">
                    <form id="editPlaylistForm" method="post"> 
                        ...
                        <h3>Edit Playlist Metadata</h3>
    
                        <h4 style="margin-bottom:0px; margin-top: 20px;">Name</h4>
...
?>
                <div class="body-content">
                    <div class="alert alert-danger" style="text-align: center">
                        <strong>Error:</strong> You do not have permission to modify the selected playlist.
                    </div>
                </div>
<?php
            }
